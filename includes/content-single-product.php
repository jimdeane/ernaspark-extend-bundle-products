...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	...
	?>
	in content single product 2
	<div class="summary entry-summary">
		<div>
			<h2> this is where the product stuff goes</h2>
			<div>
				<div><h4>Printed Report</h4> main product details
					...
					<div><h4>Individual Articles for Download</h4> Repeating group fo sub products / articles
					<?PHP
	...
	<div>	in content single product 3</div>
	<?php
	/**
